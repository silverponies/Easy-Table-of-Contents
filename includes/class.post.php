	...
	public function getTOC() {
		...
		if ( $this->hasTOCItems() ) {
			...
			if ( ezTOC_Option::get( 'show_heading_text' ) ) {
				...
				$html .= '<div class="custom-toc-title"><p class="ez-toc-title">' . esc_html__( htmlentities( $toc_title, ENT_COMPAT, 'UTF-8' ), 'easy-table-of-contents' ). '</p><hr class="custom-delimiter-title" /></div>' . PHP_EOL;
